...
import { sendRecoverPasswordEmailMutation } from './send-recover-password-email-document'
...
const feature = loadFeature(resolve(__dirname, 'send-recover-password-email.feature'))
